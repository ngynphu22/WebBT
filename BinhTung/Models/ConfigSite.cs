...
namespace BinhTung.Models
{
    public class ConfigSite
    {
        ...
        [Display(Name = "Đường dẫn video"), StringLength(500, ErrorMessage = "Tối đa 500 ký tự"), UIHint("TextBox")]
        public string VideoUrl { get; set; }
        [Display(Name = "link hồ sơ pháp lý"), StringLength(500, ErrorMessage = "Tối đa 500 ký tự"), UIHint("TextBox")]
        public string FileUrl { get; set; }
        [Display(Name = "Link lịch sử phát triển"), StringLength(500, ErrorMessage = "Tối đa 500 ký tự"), UIHint("TextBox")]
